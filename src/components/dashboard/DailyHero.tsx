...
export default function DailyHero() {
  ...
  return (
    <Card className="rounded-2xl border-0 shadow-card-subtle hover:shadow-card-elevated transition-shadow duration-300 overflow-hidden">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3">
                <Badge variant="secondary" className="bg-card-gradient border-0 shadow-theme-subtle hover:shadow-theme px-3 py-1.5 transition-shadow duration-300">
