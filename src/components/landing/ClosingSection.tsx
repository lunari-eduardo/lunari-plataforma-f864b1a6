  ...
  return (
    <SectionShell className="relative overflow-hidden bg-[#0A0A0A] text-[#FAFAF7]">
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side at 50% 0%, rgba(176,99,47,0.35), transparent 70%)",
        }}
      />
      <div className="relative text-center">
        ...
        <Reveal delay={0.15}>
          <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <button
              onClick={() => nav("/auth")}
              className="h-12 rounded-[6px] bg-[#b0632f] px-8 text-[16px] font-semibold text-[#0A0A0A] transition-all hover:-translate-y-[1px] hover:brightness-105"
              style={uiFont}
            >
