...
const features = [
  {
    ...
    items: [
      "4 visualizações (diária, semanal, mensal, anual)",
  ...
  },
  {
    ...
    items: [
      ...
      "Gestão de parcelamentos e cartões",
  ...
  },
  {
    ...
    items: [
      "Gerencie etapas do projeto",
      "Controle de pagamentos",
      "Produtos inclusos, fotos extras",
  ...
  },
  {
    ...
    items: [
      "Histórico completo de sessões e pagamentos",
    ...
    <section className="py-20 bg-landing-bg">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-landing-text/70 max-w-2xl mx-auto">
            Pilares com punchlines que fazem diferença no seu dia a dia
          </p>
        </div>
        ...
        <div className="mt-20 text-center">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-4 max-w-4xl mx-auto mb-8">
            {[
              ...
              <div key={index} className="bg-white rounded-lg p-4 shadow-sm border border-landing-brand/10">
