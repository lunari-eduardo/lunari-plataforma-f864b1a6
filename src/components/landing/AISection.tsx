  ...
  return (
    <SectionShell id="ia" className="relative overflow-hidden bg-[#0A0A0A] text-[#FAFAF7]">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(201,168,124,0.35), transparent 70%)",
        }}
      />
      ...
      <div className="relative">
        ...
        <Reveal delay={0.05}>
          ...
          >
            ...
            <span className="italic text-[#C9A87C]">A Lu responde.</span>
          </h2>
        </Reveal>
          ...
          <div className="mx-auto mt-16 max-w-[720px]">
            <div className="rounded-[16px] border border-white/10 bg-white/[0.03] p-6 backdrop-blur-sm">
              <div className="mb-4 flex items-center gap-2.5" style={uiFont}>
                <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#C9A87C] text-[12px] font-semibold text-[#0A0A0A]" style={displayFont}>
                  Lu
                </span>
              ...
              <div className="space-y-3" style={monoFont}>
                {questions.map((q, i) => (
                  <div key={q} className="flex items-start gap-3 text-[13px]">
                    <span className="text-[#C9A87C]/70">›</span>
              ...
              <div className="mt-6 border-t border-white/8 pt-5">
                ...
                <p
                  ...
                  style={displayFont}
                >
                  Este mês você fechou <span className="text-[#C9A87C]">17 sessões</span>,
                  faturou <span className="text-[#C9A87C]">R$ 24.380</span> líquido e
                  tem <span className="text-[#C9A87C]">4 clientes</span> com extras
