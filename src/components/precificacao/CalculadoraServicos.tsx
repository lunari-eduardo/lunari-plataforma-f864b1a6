        ...
        <div className="flex justify-center">
          <Collapsible open={isOpen} onOpenChange={setIsOpen}>
            <CollapsibleTrigger asChild>
              <Button className="bg-amber-500/20 border border-amber-500/30 text-amber-800 hover:bg-amber-500/30 flex items-center justify-center gap-2 px-4 py-2 rounded-lg">
