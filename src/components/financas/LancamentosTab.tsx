...
export default function LancamentosTab({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Tabs value={activeSubTab} onValueChange={(value) => setActiveSubTab(value as GrupoPrincipal)}>
              <TabsList className="flex h-10 p-1 bg-white border border-gray-200 rounded-lg">
                <TabsTrigger 
                  value="Despesa Fixa" 
                  className="flex items-center gap-2 text-sm py-2 px-4 data-[state=active]:bg-gray-50 data-[state=active]:text-red-600"
                >
                ...
                <TabsTrigger 
                  ...
                  className="flex items-center gap-2 text-sm py-2 px-4 data-[state=active]:bg-gray-50 data-[state=active]:text-orange-600"
                >
                ...
                <TabsTrigger 
                  value="Investimento" 
                  className="flex items-center gap-2 text-sm py-2 px-4 data-[state=active]:bg-gray-50 data-[state=active]:text-purple-600"
                >
                  <TrendingUp className="h-4 w-4" />
                  Investimentos
                </TabsTrigger>
                <TabsTrigger 
                  value="Receita Não Operacional" 
                  className="flex items-center gap-2 text-sm py-2 px-4 data-[state=active]:bg-gray-50 data-[state=active]:text-green-600"
                >
        ...
        {isMobile && (
          <div className="space-y-4">
            ...
            <Tabs value={activeSubTab} onValueChange={(value) => setActiveSubTab(value as GrupoPrincipal)}>
              <TabsList className="grid grid-cols-2 h-10 p-1 bg-white border border-gray-200 rounded-lg w-full">
                <TabsTrigger 
                  value="Despesa Fixa" 
                  className="flex items-center gap-1 text-xs py-2 px-2 data-[state=active]:bg-gray-50 data-[state=active]:text-red-600"
                >
                ...
                <TabsTrigger 
                  value="Despesa Variável" 
                  className="flex items-center gap-1 text-xs py-2 px-2 data-[state=active]:bg-gray-50 data-[state=active]:text-orange-600"
                >
              ...
              <TabsList className="grid grid-cols-2 h-10 p-1 bg-white border border-gray-200 rounded-lg w-full">
                <TabsTrigger 
                  value="Investimento" 
                  className="flex items-center gap-1 text-xs py-2 px-2 data-[state=active]:bg-gray-50 data-[state=active]:text-purple-600"
                >
                ...
                <TabsTrigger 
                  value="Receita Não Operacional" 
                  className="flex items-center gap-1 text-xs py-2 px-2 data-[state=active]:bg-gray-50 data-[state=active]:text-green-600"
                >
      ...
      <Tabs value={activeSubTab} onValueChange={(value) => setActiveSubTab(value as GrupoPrincipal)}>
        {(['Despesa Fixa', 'Despesa Variável', 'Investimento', 'Receita Não Operacional'] as GrupoPrincipal[]).map(grupo => (
          <TabsContent key={grupo} value={grupo} className="mt-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
              ...
              {isMobile ? (
                <TabelaLancamentosMobile
                  transacoes={transacoesPorGrupo[grupo]}
