            ...
            <div className="flex flex-col items-center">
              <div 
                className={`
                  ...
                  ${step.number <= currentStep 
                    ? 'bg-[hsl(var(--primary))] border-[hsl(var(--primary))] text-primary-foreground' 
                    : 'bg-card/20 border-white/30 text-primary-foreground/60'
                  }
                `}
              >
                {step.number < currentStep ? (
              ...
              <span 
                className={`
                  ...
                  ${step.number <= currentStep ? 'text-[hsl(var(--primary))]' : 'text-primary-foreground/60'}
                `}
              >
                {step.label}
              </span>
            ...
            {index < steps.length - 1 && (
              <div 
                className={`
                  ...
                  transition-all duration-300
                  ${step.number < currentStep ? 'bg-[hsl(var(--primary))]' : 'bg-card/30'}
                `}
              />
            )}
          </React.Fragment>
