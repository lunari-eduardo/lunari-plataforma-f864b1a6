    ...
    >
      ...
      <div className="flex items-center justify-between">
        <Button
          variant="ghost"
          size="sm"
          className="h-8 text-xs hover:bg-black/[0.06] dark:hover:bg-card/10 transition-colors"
          onClick={onEdit}
          data-no-drag="true"
        >
          Ver detalhes
        ...
        {!isDone ? (
          <Button
            variant="secondary"
            size="sm"
            className="h-8 text-xs hover:bg-black/[0.08] dark:hover:bg-card/10 transition-colors"
            onClick={onComplete}
            data-no-drag="true"
          >
            Concluído
