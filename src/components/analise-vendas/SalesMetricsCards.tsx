...
export function SalesMetricsCards() {
  ...
  return <div className="grid grid-cols-0 md:grid-cols-3 lg:grid-cols-6 gap-2 py-2 my-0 px-[34px]">
      ...
      return <Card key={index} className="border-0 shadow-lg bg-lunar-surface hover:shadow-xl transition-all duration-200">
            ...
            <CardContent className="pt-0">
              <div className="space-y-1">
                ...
                {metric.trend === 'neutral' && <Badge variant="outline" className="text-2xs">
                    {metric.change}
                  </Badge>}
              </div>
            </CardContent>
