...
export function ProductSearchCombobox({
  ...
  // Função para obter o valor correto do produto
                ...
                return (
                  <CommandItem
                    ...
                    onSelect={(currentValue) => {
                      console.log('ProductSearchCombobox: onSelect chamado', { product, currentValue });
                      // Primeiro atualizamos a seleção
                      const selected = products.find(p => p.nome === currentValue);
                      if (selected) {
                        onSelect(selected);
                        setSelectedValue(""); // Reset selection after adding
                      }
                      // Depois fechamos o menu (ordem importante)
                      setOpen(false);
                    }}
