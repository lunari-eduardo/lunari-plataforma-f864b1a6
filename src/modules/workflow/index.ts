...
import "./application/queries/photoProductionForYear";
import "./application/queries/vendasResumo";
import "./application/queries/vendasCompararAnos";
import "./application/queries/vendasMetasProgresso";
...
export { photoProductionForYear } from "./application/queries/photoProductionForYear";
export { vendasResumo } from "./application/queries/vendasResumo";
export { vendasCompararAnos } from "./application/queries/vendasCompararAnos";
export { vendasMetasProgresso } from "./application/queries/vendasMetasProgresso";
