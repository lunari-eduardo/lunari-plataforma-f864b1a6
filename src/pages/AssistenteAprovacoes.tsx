    ...
    <div className="max-w-4xl mx-auto px-4 md:px-6 py-8 space-y-6">
      <div>
        <h1 className="text-2xl font-semibold flex items-center gap-2">
          <ShieldAlert className="h-6 w-6" /> Aprovações da Lu (MCP)
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          Ações destrutivas disparadas por assistentes externos aguardam sua aprovação aqui.
          Cada aprovação gera um token de uso único que expira em 15 minutos.
        </p>
      </div>
