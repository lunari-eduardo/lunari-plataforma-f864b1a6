...
export default function Tarefas() {
  ...
  return <main className="page-tarefas p-4 space-y-4">
      ...
      <TaskFormModal open={createOpen} onOpenChange={setCreateOpen} mode="create" onSubmit={(data: any) => {
      const t = addTask({
        ...data,
        source: 'manual'
      });
      ...
      <TemplateManagerModal open={showTemplateManager} onOpenChange={setShowTemplateManager} />
