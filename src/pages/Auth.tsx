...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-lunar-accent/60 via-lunar-accent/50 to-lunar-accent/60" />
              ...
              <>
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-black/20 px-2 text-white/60">ou</span>
                  </div>
                </div>
