...
export const useResponsiveLayout = () => {
  ...
  const getResponsiveClasses = () => ({
    ...
    timeLabel: isMobile ? 'text-[10px] px-2 bg-card/30 dark:bg-card/[0.04]' : isTablet ? 'text-[10px] px-2 bg-card/30 dark:bg-card/[0.04]' : 'text-xs px-3 md:px-4 bg-card/30 dark:bg-card/[0.04]'
  });
