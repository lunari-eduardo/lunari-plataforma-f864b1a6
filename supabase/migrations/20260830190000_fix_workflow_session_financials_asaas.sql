-- ==============================================================================
-- Migration: fix_workflow_session_financials_asaas
-- Description: Rateio de pagamentos de extras via parcelas de gateways (Asaas).
-- Corrige o problema onde o workflow contabilizava o recebimento de extras em 0
-- porque o Asaas não grava mais em clientes_transacoes, e sim gateway_cash_movements.
-- ==============================================================================
