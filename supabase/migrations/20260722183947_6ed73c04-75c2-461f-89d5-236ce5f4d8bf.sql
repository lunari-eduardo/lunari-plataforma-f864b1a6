...
-- =====================================================================
-- Fix: workflow_session_financials — modo override respeita unitário
-- digitado manualmente (não aplica faixa de desconto progressivo).
-- =====================================================================
...
BEGIN
  ...
  -- FIX: em override/manual sem galeria consolidada, respeitar o unitário
  -- digitado (não aplicar faixa de desconto progressivo).
  ...
  ELSE
    ...
    -- Pagamentos manuais sem tag INTENT e sem cobrança vinculada → genéricos.
    -- Rateados proporcionalmente entre sessão e extras (fallback legado).
    SELECT COALESCE(SUM(t.valor), 0)
