...
-- Recriar view extrato_unificado com JOIN em cobrancas para provedor e galeria_id
CREATE OR REPLACE VIEW extrato_unificado AS

-- Entradas do workflow (clientes_transacoes)
SELECT 
    ct.id::text AS id,
...
-- Taxas de gateway (saídas virtuais)
SELECT 
