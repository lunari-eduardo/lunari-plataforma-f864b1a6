-- ============================================================
-- SECURITY FIX: Add security_invoker to extrato_unificado view
-- This ensures RLS policies are enforced from the caller's context
-- ============================================================
...
COMMENT ON VIEW extrato_unificado IS 'View unificada com security_invoker que combina receitas e despesas para o extrato financeiro, respeitando RLS do usuário autenticado';